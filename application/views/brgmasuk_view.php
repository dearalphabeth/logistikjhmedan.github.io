...
<html lang="en">
    <head>
        ...
        <title>Barang Masuk - Logistik Jims Honey</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <a href="<?php echo site_url('cetakmasuk'); ?>" target="_blank">
...
<table id="datatablesSimple">
    ...
    <tbody>
        <?php foreach ($masuk as $msk): ?>
            <tr>
                <td><?php echo $msk->idmasuk; ?></td>
                <td><?php echo $msk->nama_brg; ?></td>
                <td><?php echo $msk->desk; ?></td>
                <td><?php echo $msk->jumlah; ?></td>
                <td><?php echo $msk->tanggal; ?></td>
                <td><?php echo $msk->penerima; ?></td>
                <td>
                    <button class="btn btn-warning" data-toggle="modal" data-target="#editModal<?php echo $msk->idmasuk; ?>">Edit</button>
                    <a href="<?php echo site_url('brgmasuk/delete_masuk/'.$msk->idmasuk); ?>" class="btn btn-danger" onclick="return confirm('Yakin akan menghapus?');">Hapus</a>
                </td>
            </tr>

            <!-- Edit Modal -->
            <div class="modal fade" id="editModal<?php echo $msk->idmasuk; ?>" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Edit Permintaan Barang</h5>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
                            <form action="<?php echo site_url('brgmasuk/edit_masuk'); ?>" method="POST">
                                <input type="hidden" name="idmasuk" value="<?php echo $msk->idmasuk; ?>">
                                <div class="form-group">
                                    <label for="idmasuk">ID Barang Masukk</label>
                                    <input type="text" class="form-control" name="idmasuk" value="<?php echo $msk->idmasuk; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="nama_brg">Nama Barang</label>
                                    <input type="text" class="form-control" name="nama_brg" value="<?php echo $msk->nama_brg; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="jumlah">Jumlah</label>
                                    <input type="text" class="form-control" name="jumlah" value="<?php echo $msk->jumlah; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="tanggal">Tanggal</label>
                                    <input type="date" class="form-control" name="tanggal" value="<?php echo $msk->tanggal; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="penerima">Penerima</label>
                                    <input type="text" class="form-control" name="penerima" value="<?php echo $msk->penerima; ?>" required>
                                </div>
                                <br>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <!-- Modal Body -->
      <div class="modal-body">
        <form action="<?php echo site_url('brgmasuk/add_masuk'); ?>" method="POST">

            <div class="form-group">
                <label for="idmasuk">ID Masuk</label>
                <input type="text" name="idmasuk" id="idmasuk" placeholder="ID Masuk" class="form-control" required>
            </div>
            <br>
            <div class="form-group">
                <label for="nama_brg">Nama Barang</label>
