...
<html lang="en">
    <head>
        ...
        <title>Register - Logistik Jims Honey</title>
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="group" type="text" placeholder="Enter your first name" />
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="login.html">Sudah Punya Akun? Silahkan Login!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
