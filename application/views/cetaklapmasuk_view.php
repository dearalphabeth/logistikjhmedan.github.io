...
<html lang="en">
    <head>
        ...
        <title>Barang Masuk - Logistik Jims Honeyy Medan</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <h2 class="mt-4">Cetak Laporan Permintaan Barang</h2>
...
<div>
    ...
    <a id="print_link" href="<?php echo site_url('brgmasuk/print_report'); ?>" target="_blank">
    ...
    <script>
        function filterReport() {
            ...
            print_link.href = "<?php echo site_url('brgmasuk/print_report'); ?>?name=" + name + "&start_date=" + start_date + "&end_date=" + end_date;
        }
    </script>
